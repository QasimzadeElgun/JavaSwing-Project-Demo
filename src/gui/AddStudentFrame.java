...
public class AddStudentFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField5.setText("         Add Student");
    ...
    private void saveIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveIdActionPerformed
        try {
            ...
            student.setId((int) Long.parseLong(Idtxt.getText()));
            student.setName(nametxt.getText());
            student.setSurname(surnametxt.getText());
            student.setActive(Integer.parseInt(activetxt.getText()));
            boolean isAdded = sd.addStudent(student);
            if (isAdded) {
                JOptionPane.showMessageDialog(null, "Student has been added", "Add Student", HEIGHT);
                this.dispose();
            } else {
