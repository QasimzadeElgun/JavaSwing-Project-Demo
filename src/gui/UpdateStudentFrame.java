...
public class UpdateStudentFrame extends javax.swing.JFrame {
    ...
    UpdateStudentFrame(studentDao sd, int selectedId) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextField5.setText("       Update Student");
    ...
    private void saveIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveIdActionPerformed
        try {
            student.setId(Integer.valueOf(Idtxt.getText()));
            student.setName(nametxt.getText());
            student.setSurname(surnametxt.getText());
            student.setActive(Integer.valueOf(activetxt.getText()));
            boolean isUpdate = sd.updateStudent(student);
            if(isUpdate){
                JOptionPane.showMessageDialog(null, "Student has been updated","Update Student" , HEIGHT);
                this.dispose();
            }else{
                JOptionPane.showMessageDialog(null, "Error!","Update Student"  , HEIGHT);
            }
        } catch (Exception ex) {
            Logger.getLogger(UpdateStudentFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
